...
public class ComboDB_v6 {
	...
	public ComboDB_v6(String nom, PersonnageDB perso, boolean mod) {
		this.nom = nom;
		this.perso = perso;
		if(mod) {
			this.init = 0;
...
//	int persoId;
	...
	public ComboDB_v6 copy(PersonnageDB newPerso) {
		ComboDB_v6 combo = new ComboDB_v6();
		combo.setCaC(CaC);
